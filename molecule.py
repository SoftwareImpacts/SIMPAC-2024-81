...
class Molecule:
    """
    Represents and manages molecules, supporting property management, transformations, and SMILES-based initialization.

    Attributes:
    - global_counter (int): Class-level counter for unique molecule IDs.
    - molecule_counter (defaultdict): Counts instances per molecule type for unique type-specific IDs.

    Parameters:
    - name (str): Name/type of the molecule for identification.
    - info (Dict[str, Any]): Essential molecule information, e.g., SMILES string.
